...
<p>
  ...
  <a href="https://www.ynu.edu.cn">
    <img src="https://img.shields.io/badge/云南大学-信息学院-2563EB?style=for-the-badge" />
  </a>
  <a href="https://github.com/Easesgr/anyiai-docs">
    <img src="https://img.shields.io/badge/AnyiAI-学习文档-06B6D4?style=for-the-badge" />
  </a>
</p>
...
我是 **Anyi / Easesgr**，主要关注 **人工智能、计算机视觉、图像复原与 AI 工程实践**。


目前的研究和项目方向主要分为 **科研方向** 和 **Agent 开发** 两条主线：
...
<table>
  <tr>
    <td width="50%">
      <h3>🔬 科研方向</h3>
      <ul>
        <li>🧠 All-in-One 图像复原</li>
        <li>🌧️ 单图去雨与真实场景图像增强</li>
        <li>🌫️ 图像去雾、去噪、去模糊、低光增强</li>
        <li>🧩 多退化统一建模与任务自适应恢复</li>
        <li>📚 AI 学习路线、面试题整理与开源知识库建设</li>
      </ul>
    </td>
    <td width="50%">
      <h3>🤖 Agent 开发</h3>
...
<table>
  <tr>
    <td width="50%">
      <h3>🖼️ 图像复原</h3>
      <p>
        关注图像去雨、去噪、去模糊、去雾、低光增强等视觉退化恢复问题，
        目标是在复杂真实场景下提升图像质量和模型泛化能力。
      </p>
    </td>
    <td width="50%">
      <h3>🧩 统一多退化复原</h3>
      <p>
        探索一个模型同时处理多种退化类型，通过提示学习、特征调制、
        任务感知建模等方式提升 All-in-One Image Restoration 能力。
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td width="50%">
      <h3>📚 AI 知识工程</h3>
      <p>
        构建 AI 学习路线、面试题合集、论文解读、项目实战和工程化部署笔记，
        让知识可以被系统整理和持续复用。
      </p>
    </td>
  </tr>
...
<p align="center">
  ...
  <a href="https://www.ynu.edu.cn">
    <img src="https://img.shields.io/badge/云南大学-信息学院-2563EB?style=flat-square" />
  </a>
  <a href="https://github.com/Easesgr/anyiai-docs">
    <img src="https://img.shields.io/badge/AI文档-anyiai--docs-06B6D4?style=flat-square" />
  </a>
</p>
